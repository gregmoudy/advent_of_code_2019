...
if __name__ == '__main__':
	...
	print( 'Total fuel required: {0}'.format( total_fuel ) ) # 3336985
	...
	for mass in masses:
		...
		# Calculate the fuel needed for the mass of the fuel and so on.
		while mass_fuel > 0:
			mass_total_fuel += mass_fuel
			mass_fuel = ( mass_fuel // 3 ) - 2

		all_fuel_masses.append( mass_total_fuel )

	total_fuel = sum( all_fuel_masses )

	print( 'Total fuel required including fuel mass: {0}'.format( total_fuel ) ) # 5002611
